...
<html lang="en-us"><head>
    ...
    <title>Adcap | Hypackel</title>
    <link rel="stylesheet" href="TemplateData/style.css">
    <script src="TemplateData/UnityProgress.js"></script>
</head>

<body class="template">
    <canvas class="emscripten" id="canvas" oncontextmenu="event.preventDefault()" height="640" width="1024"></canvas>
    ...
    </script><script src="Release/webgl.js"></script>
